// Bundled go extractor binary for darwin-arm64 (embedded as a bunfs asset).
//
...
import bin from "/home/shivang/Folder E/DevLens Workspace/DevLens OSS/node_modules/devlensio/extractors/go/bin/darwin-arm64/devlens_go_extractor";
export default bin;
