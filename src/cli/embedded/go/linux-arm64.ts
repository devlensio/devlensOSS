// Bundled go extractor binary for linux-arm64 (embedded as a bunfs asset).
//
...
import bin from "/home/shivang/Folder E/DevLens Workspace/DevLens OSS/node_modules/devlensio/extractors/go/bin/linux-arm64/devlens_go_extractor";
export default bin;
