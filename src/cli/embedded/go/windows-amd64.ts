// Bundled go extractor binary for windows-amd64 (embedded as a bunfs asset).
//
...
import bin from "/home/shivang/Folder E/DevLens Workspace/DevLens OSS/node_modules/devlensio/extractors/go/bin/windows-amd64/devlens_go_extractor.exe";
export default bin;
