// Bundled java extractor fat jar (embedded as a bunfs asset).
//
...
import bin from "/home/shivang/Folder E/DevLens Workspace/DevLens OSS/node_modules/devlensio/extractors/java/devlens_java_extractor.jar";
export default bin;
